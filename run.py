...
ax.bar(_X-0.2, gpm*100, 0.4, label='GPM')
ax.bar(_X+0.2, npm*100, 0.4, label='NPM')
ax.set_xticks(_X)
ax.set_xticklabels(rev_date_str)
ax.set_xlabel('Date')
ax.set_ylabel('%')
ax.set_title(fn)
ax.tick_params(axis='x', rotation=90)
...
ax = plt.axes()
_X = np.arange(len(rev_date))
ax.bar(_X-0.2, ttm_gpm*100, 0.4, label='GPM')
ax.bar(_X+0.2, ttm_npm*100, 0.4, label='NPM')
ax.set_xticks(_X)
ax.set_xticklabels(rev_date_str)
ax.set_xlabel('Date')
ax.set_ylabel('%')
